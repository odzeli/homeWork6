...
//строку для StreamReader и массив int для BinaryReader//Выполнил 4-ю задачу т.к. для первых двух не нашел примеры для переделывания, а 3-я заняла бы ооочень много времени. //Надеюсь на ваше понимание и на то, что ее две звездочки заменяют другие задачи.
using System;
using System.IO;
